...
object SimpleApp {
  def main(args: Array[String]): Unit = {
    ...
    spark.sql("select * from basic_test.acid").show()
    ...
    // .option("url", "jdbc:hive2://hiveserver2:10000/") // org.apache.hive.service.cli.HiveSQLException: Error while compiling statement: FAILED: SemanticException [Error 10265]: This command is not allowed on an ACID table basic_test.acid with a non-ACID transaction manager. Failed command: SELECT * FROM basic_test.acid WHERE 1=0
